    ...
    while (have_posts()) : the_post(); // 繰り返し処理開始 ?>
      <div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
        ...
        foreach($users as $user):
            ...
            // nointro user
            if(strpos($userData->user_description, 'nointro') !== false)
                continue;?>
            <div class="writer-profile">
                <figure class="eyecatch"><?php echo get_avatar($uid, 300); ?></figure>
                <div class="profiletxt">
                    <p class="name"><?php echo $user->display_name; ?></p>
                    <div class="description"><?php echo wpautop($userData->user_description); ?></div>
                    <div class="link"><a href="<?php echo get_author_posts_url($uid); ?>"><?php echo $user->display_name; ?></a></div>
                </div>
            </div>
        <?php endforeach; ?>
        </div>
